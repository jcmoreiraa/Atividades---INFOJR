...
const components: JSXMapSerializer = {
  ...
  paragraph: ({ children }) => (
    <p className="text-xl md:text-1xl font-normal font-body text-slate-600 mb-8">
      {children}
    </p>
  ),
};
    ...
    >
      ...
      <div className="grid lg:grid-cols-2 gird-cols 1 gap-8">
        {testimonials.map((item, index)=> item && (
          <div key='index' className="border bg-white shadow-lg reunded-lg px-8 md:px-14 py-10 md:py-16 grid content-between">
